 ...
 */
public class JPresentacion extends javax.swing.JFrame {

    /**
     * Creates new form JPresentacion
     */
    public JPresentacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnIngresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 260, -1, -1));
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
      ...
      userMainVist log = new userMainVist();
      log.setVisible(true);
      dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JPresentacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JPresentacion().setVisible(true);
            }
        });
    }
